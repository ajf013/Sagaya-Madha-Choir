...
const Footer = () => {
    return (
        <div data-aos="fade-up" className="footer_main" style={{
            ...
            <div className="footer_Icons" style={{
                display: 'flex',
                ...
                <span className="footer_git">
                    <a target="_blank" rel="noreferrer noopener" href="https://github.com/ajf013" aria-label="GitHub">
                        <svg viewBox="0 0 24 24" aria-hidden="true" style={{ width: '26px', height: '26px', fill: '#1e293b', transition: 'all 0.3s' }}>
                ...
                <span className="footer_twi">
                    <a target="_blank" rel="noreferrer noopener" href="https://x.com/Itsme_Ajf013" aria-label="X (formerly Twitter)">
                        <svg viewBox="0 0 24 24" aria-hidden="true" style={{ width: '26px', height: '26px', fill: '#1e293b', transition: 'all 0.3s', verticalAlign: 'middle', marginTop: '-3px' }}>
                            <g>
            ...
            <div className="footer_content" style={{
                ...
                <Copyright size={16} />
                <span>{new Date().getFullYear()} <strong>Francis Cruz</strong></span>
            </div>
        </div>
    );
};
